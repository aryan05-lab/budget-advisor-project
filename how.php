...
<div <div style="padding:120px 60px; max-width:900px; margin:auto;">
    ...
    <h1 style="font-family:'Playfair Display';">How It Works</h1>

    <p style="margin-top:15px; color:#666;">
        Our platform simplifies financial tracking by giving users complete control over their expenses and insights.
    </p>
    ...
    <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(250px,1fr)); gap:20px; margin-top:30px;">
        ...
        <div style="background:white; padding:20px; border-radius:12px; box-shadow:0 5px 15px rgba(0,0,0,0.08);">
            ...
            <p style="color:#555;">Record daily spending and organize it by categories.</p>
        </div>

        <div style="background:white; padding:20px; border-radius:12px; box-shadow:0 5px 15px rgba(0,0,0,0.08);">
            <h3>💰 Monitor Income</h3>
            <p style="color:#555;">Keep track of your earnings and balance.</p>
        </div>

        <div style="background:white; padding:20px; border-radius:12px; box-shadow:0 5px 15px rgba(0,0,0,0.08);">
            <h3>📈 Analyze Patterns</h3>
            <p style="color:#555;">Understand where your money goes.</p>
        </div>

        <div style="background:white; padding:20px; border-radius:12px; box-shadow:0 5px 15px rgba(0,0,0,0.08);">
            <h3>🧾 Maintain Records</h3>
            <p style="color:#555;">All transactions stored safely in database.</p>
        </div>
