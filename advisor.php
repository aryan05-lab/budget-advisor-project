...
<div <div style="padding:120px 60px; max-width:900px; margin:auto;">
    ...
    <h1 style="font-family:'Playfair Display';">Find an Advisor</h1>

    <p style="margin-top:15px; color:#666;">
        Get smart financial guidance based on your spending behavior and habits.
    </p>
    ...
    <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(250px,1fr)); gap:20px; margin-top:30px;">
        ...
        <div style="background:white; padding:20px; border-radius:12px; box-shadow:0 5px 15px rgba(0,0,0,0.08);">
            ...
            <p style="color:#555;">Identify unnecessary spending.</p>
        </div>

        <div style="background:white; padding:20px; border-radius:12px; box-shadow:0 5px 15px rgba(0,0,0,0.08);">
            <h3>📊 Budget Planning</h3>
            <p style="color:#555;">Create a smart monthly budget.</p>
        </div>

        <div style="background:white; padding:20px; border-radius:12px; box-shadow:0 5px 15px rgba(0,0,0,0.08);">
            <h3>💡 Smart Decisions</h3>
            <p style="color:#555;">Improve financial habits over time.</p>
        </div>
